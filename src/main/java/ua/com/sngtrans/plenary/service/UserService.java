...
import ua.com.sngtrans.plenary.repository.*;
...
public class UserService {
    ...
    public User createUser(String login, String password, String firstName, String middleName, String lastName,
                           String email, String imageUrl, String langKey, Long companyId, Long branchId) {
    ...
    public User createUser(UserDTO userDTO) {
        ...
        Branch branch = branchRepository.findOne(userDTO.getBranchId());
     ...
     */
    public void updateUser(String firstName, String middleName, String lastName, String email, String langKey, String imageUrl, Long companyId, Long branchId) {
        userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).ifPresent(user -> {
            ...
            user.setBranch(branchRepository.findOne(branchId));
            userSearchRepository.save(user);
